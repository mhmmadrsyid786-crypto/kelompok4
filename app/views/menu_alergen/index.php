            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $i++; ?></td>
                            <td><?= esc($ma['nama_menu']); ?></td>
                            <td><?= esc($ma['nama_alergi']); ?></td>
                            <td>
                                <a href="#" onclick="openUpdateModal('<?= esc($ma['id_menu_alergen']); ?>', '<?= esc($ma['id_menu']); ?>', '<?= esc($ma['id_alergi']); ?>'); return false;" class="btn-sm btn-sm-edit">Edit</a>
                                <a href="<?= BASEURL; ?>/menu_alergen/hapus/<?= esc($ma['id_menu_alergen']); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus pemetaan alergen ini?');" class="btn-sm btn-sm-delete">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
